#!/usr/bin/env python3
"""
Real testnet deployment with working approach
"""
...
def create_minimal_teal():
    """Create minimal TEAL program"""
    # TEAL version 2, minimal program
    teal_code = """
#pragma version 2
int 1
return
...
def compile_teal_to_bytes(teal_code):
    """Compile TEAL to bytes"""
    # Simple base64 encoding for minimal TEAL
    return base64.b64encode(teal_code.encode()).decode()
